...
return new class extends Migration
{
    ...
    {
        Schema::create('layanan_d_i_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('tarif_konsultasi')->nullable();
            $table->json('tarif_desain')->nullable();
            $table->json('tarif_renovasi')->nullable();
    ...
    {
        Schema::dropIfExists('layanan_d_i_s');
    }
};