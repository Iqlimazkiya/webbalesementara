<footer style="background:#0a2018;font-family:'Montserrat',sans-serif;position:relative;overflow:hidden;">
    ...
    <div style="max-width:1280px;margin:0 auto;padding:48px 24px 32px;">
        ...
        <div style="display:grid;grid-template-columns:1fr;gap:36px;" class="footer-grid">
            ...
            <div>
                <img src="<?php echo e(asset('assets/img/logofix.png')); ?>" alt="Bale Hinggil" style="height:56px;width:auto;margin-bottom:16px;filter:brightness(1.3);">
                ...
                <div style="display:flex;gap:8px;margin-top:20px;flex-wrap:wrap;">
                    <a href="#" style="width:34px;height:34px;border-radius:50%;background:rgba(208,176,104,0.1);border:1px solid rgba(208,176,104,0.2);display:flex;align-items:center;justify-content:center;transition:all .25s;text-decoration:none;"
                       ...
                       onmouseout="this.style.background='rgba(208,176,104,0.1)';this.style.borderColor='rgba(208,176,104,0.2)';">
                        <img src="<?php echo e(asset('assets/img/iconfb.png')); ?>" alt="Facebook" style="width:15px;height:15px;filter:brightness(10);">
                    </a>
                    <a href="#" style="width:34px;height:34px;border-radius:50%;background:rgba(208,176,104,0.1);border:1px solid rgba(208,176,104,0.2);display:flex;align-items:center;justify-content:center;transition:all .25s;text-decoration:none;"
                       onmouseover="this.style.background='rgba(208,176,104,0.25)';this.style.borderColor='rgba(208,176,104,0.5)';"
                       onmouseout="this.style.background='rgba(208,176,104,0.1)';this.style.borderColor='rgba(208,176,104,0.2)';">
                        <img src="<?php echo e(asset('assets/img/icontiktok.png')); ?>" alt="TikTok" style="width:15px;height:15px;filter:brightness(10);">
                    </a>
                    <a href="#" style="width:34px;height:34px;border-radius:50%;background:rgba(208,176,104,0.1);border:1px solid rgba(208,176,104,0.2);display:flex;align-items:center;justify-content:center;transition:all .25s;text-decoration:none;"
                       onmouseover="this.style.background='rgba(208,176,104,0.25)';this.style.borderColor='rgba(208,176,104,0.5)';"
                       onmouseout="this.style.background='rgba(208,176,104,0.1)';this.style.borderColor='rgba(208,176,104,0.2)';">
                        <img src="<?php echo e(asset('assets/img/iconinsta.png')); ?>" alt="Instagram" style="width:15px;height:15px;filter:brightness(10);">
                    </a>
                    <a href="#" style="width:34px;height:34px;border-radius:50%;background:rgba(208,176,104,0.1);border:1px solid rgba(208,176,104,0.2);display:flex;align-items:center;justify-content:center;transition:all .25s;text-decoration:none;"
                       onmouseover="this.style.background='rgba(208,176,104,0.25)';this.style.borderColor='rgba(208,176,104,0.5)';"
                       onmouseout="this.style.background='rgba(208,176,104,0.1)';this.style.borderColor='rgba(208,176,104,0.2)';">
                        <img src="<?php echo e(asset('assets/img/iconyt.png')); ?>" alt="YouTube" style="width:15px;height:15px;filter:brightness(10);">
                    </a>
                    <a href="#" style="width:34px;height:34px;border-radius:50%;background:rgba(208,176,104,0.1);border:1px solid rgba(208,176,104,0.2);display:flex;align-items:center;justify-content:center;transition:all .25s;text-decoration:none;"
                       onmouseover="this.style.background='rgba(208,176,104,0.25)';this.style.borderColor='rgba(208,176,104,0.5)';"
                       onmouseout="this.style.background='rgba(208,176,104,0.1)';this.style.borderColor='rgba(208,176,104,0.2)';">
                        <img src="<?php echo e(asset('assets/img/iconwa.png')); ?>" alt="WhatsApp" style="width:15px;height:15px;filter:brightness(10);">
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="display:flex;flex-direction:column;gap:2px;">
                    <?php $__currentLoopData = ['tipe-unit'=>'Tipe Unit','fasilitas'=>'Fasilitas','layanan'=>'Layanan','lokasi'=>'Lokasi','berita'=>'Berita','kontak'=>'Kontak']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(in_array($url,['fasilitas','lokasi','berita','kontak','layanan']) ? url('/').'#'.$url : url('/'.$url)); ?>"
...
</style><?php /**PATH C:\laragon\www\WebsiteBaleHinggil\resources\views/layouts/user/footer.blade.php ENDPATH**/ ?>