<nav id="main-nav" class="fixed top-0 left-0 right-0 z-50 bg-transparent backdrop-blur-md border-b border-white/5 transition-all duration-500 ease-in-out h-[70px] md:h-[80px]">
    <div class="w-full h-full mx-auto px-6 md:px-10 flex justify-between items-center" style="font-family: 'Montserrat', sans-serif;">
        <div class="flex items-center">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/img/logofix.png')); ?>" alt="Bale Hinggil" class="h-[45px] md:h-[60px] w-auto object-contain cursor-pointer">
            </a>
        </div>
        <div class="hidden lg:flex items-center gap-10 text-white font-medium text-[12px] uppercase tracking-[2px]">
            ...
            ?>
            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($url == 'layanan'): ?>
                    <div class="relative group">
                        <a href="<?php echo e(Request::is('/') ? '#layanan' : url('/').'#layanan'); ?>" class="nav-link cursor-pointer <?php echo e($isLayananActive ? 'active' : ''); ?>"><?php echo e($label); ?></a>
                        <div class="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-52 bg-white rounded-xl shadow-xl opacity-0 invisible scale-95 group-hover:opacity-100 group-hover:visible group-hover:scale-100 transition-all duration-300 ease-out">
                            <a href="<?php echo e(route('layanan.wo')); ?>" class="block px-5 py-3 text-[#2d8c3e] hover:bg-gray-100 rounded-t-xl">Working Order</a>
                            <a href="<?php echo e(route('layanan.co')); ?>" class="block px-5 py-3 text-[#2d8c3e] hover:bg-gray-100">Cleaning Order</a>
                            <a href="<?php echo e(route('layanan.di')); ?>" class="block px-5 py-3 text-[#2d8c3e] hover:bg-gray-100 rounded-b-xl">Design Interior</a>
                        </div>
                    </div>
                <?php elseif(in_array($url, ['fasilitas','lokasi','berita','kontak'])): ?>
                    <a href="<?php echo e(Request::is('/') ? '#'.$url : url('/').'#'.$url); ?>" class="nav-link"><?php echo e($label); ?></a>
                <?php else: ?>
                    <a href="/<?php echo e($url); ?>" class="nav-link <?php echo e(Request::is($url) || Request::is($url.'/*') ? 'active' : ''); ?>"><?php echo e($label); ?></a>
                <?php endif; ?>
    ...
    <div id="mobile-menu"
        ...
        <div class="flex items-center justify-between px-5 shrink-0" style="height:70px;border-bottom:1px solid rgba(208,176,104,0.2);">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/img/logofix.png')); ?>" alt="Bale Hinggil" class="h-[38px] w-auto object-contain">
            </a>
                ...
                <?php if($url == 'layanan'): ?>
                    <div class="mobile-menu-item" style="border-bottom:1px solid rgba(208,176,104,0.1);">
                        <div class="flex items-center justify-between">
                            <a href="<?php echo e(Request::is('/') ? '#layanan' : url('/').'#layanan'); ?>"
                               class="mobile-link py-4 flex-1 <?php echo e($isLayananActive ? 'mobile-active' : ''); ?>"
                               data-mobile-link><?php echo e($label); ?></a>
                        ...
                        <div class="mobile-submenu hidden flex-col gap-0 pb-3 pl-2">
                            <a href="<?php echo e(route('layanan.wo')); ?>" class="mobile-sublink py-2.5" data-mobile-link>
                                <span class="dot"></span>Working Order
                            </a>
                            <a href="<?php echo e(route('layanan.co')); ?>" class="mobile-sublink py-2.5" data-mobile-link>
                                <span class="dot"></span>Cleaning Order
                            </a>
                            <a href="<?php echo e(route('layanan.di')); ?>" class="mobile-sublink py-2.5" data-mobile-link>
                                <span class="dot"></span>Design Interior
                            </a>
                        </div>
                    </div>
                <?php elseif(in_array($url, ['fasilitas','lokasi','berita','kontak'])): ?>
                    <a href="<?php echo e(Request::is('/') ? '#'.$url : url('/').'#'.$url); ?>"
                       class="mobile-link py-4"
                       style="border-bottom:1px solid rgba(208,176,104,0.1);"
                       data-mobile-link><?php echo e($label); ?></a>
                <?php else: ?>
                    <a href="/<?php echo e($url); ?>"
                       class="mobile-link py-4 <?php echo e(Request::is($url) || Request::is($url.'/*') ? 'mobile-active' : ''); ?>"
                       style="border-bottom:1px solid rgba(208,176,104,0.1);"
                       data-mobile-link><?php echo e($label); ?></a>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH C:\laragon\www\WebsiteBaleHinggil\resources\views/layouts/user/navbar.blade.php ENDPATH**/ ?>