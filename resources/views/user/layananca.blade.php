    ...
    <div class="ca-container">
        ...
        <div class="ca-mkt-grid">
            ...
            <div class="sr sr-d2">
                ...
                @php $exts=[['Sekolah & Kampus','Wisuda & acara akademik'],['UMKM & Brand Lokal','Ruang presentasi & branding'],['Content Creator','Studio konten profesional'],['Komunitas','Gathering & event berkala'],['Perusahaan / Corporate','Meeting & training rutin']]; @endphp
                @foreach($exts as $ext)
                <div class="mkt-item">
                    <div class="mkt-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg></div>
                    <div><div class="mkt-name">{{ $ext[0] }}</div><div class="mkt-sub">{{ $ext[1] }}</div></div>
                </div>
                @endforeach
            </div>
        </div>
...
<section class="ca-section ca-adv">
    <div class="ca-container">
        ...
        <div class="ca-adv-grid">
            ...
            @endphp
            @foreach($advs as $i=>$a)
            <div class="adv-card sr sr-d{{ $i+1 }}">
                <div class="adv-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">{!! $a[2] !!}</svg></div>
                <div class="adv-title">{{ $a[0] }}</div>
                <div class="adv-desc">{{ $a[1] }}</div>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="ca-section ca-branding">
    <div class="ca-container">
        ...
        <div class="ca-brand-grid">
            ...
            <div class="brand-card sr sr-d{{ $i+1 }}">
                <div class="brand-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">{!! $brandIcons[$i] !!}</svg></div>
                <div class="brand-title">{{ $b[0] }}</div>
                <ul class="brand-list">
                    @foreach(array_slice($b,1) as $item)
                    <li>{{ $item }}</li>
                    @endforeach
                </ul>
            </div>
