...
<style>
    ...
    @media (max-width:480px) { .fp-card { max-width:92vw; } }
    ...
    .fp-desc { font-size:11px; color:#6a8a6a; font-family:'DM Sans',sans-serif; line-height:1.55; margin-bottom:16px; text-align:center; }
    ...
    .back-link { display:block; text-align:center; margin-top:14px; font-size:10px; color:#c5a059; text-decoration:none; font-family:sans-serif; }
    .back-link:hover { color:#a8852f; }

    *, *:focus, *:focus-visible { outline:none !important; box-shadow:none !important; }
    .btn-submit, .btn-submit:hover { box-shadow:0 3px 12px rgba(46,168,74,.28) !important; }
    .fp-card { box-shadow:0 8px 40px rgba(0,0,0,.18) !important; }
...
<div class="login-leaf-fall" style="left:85%;animation-duration:8s;animation-delay:3s;font-size:13px;">🍂</div>
    ...
    <div class="fp-card">
        ...
        <div class="card-body">
            ...
            <div class="logo-wrap">
                ...
                <div class="page-label">Lupa Password</div>
            </div>
            ...
            <p class="fp-desc">Masukkan email kamu dan kami akan mengirimkan link untuk membuat password baru.</p>
